...
namespace MdlMgrClass
{
    public class MdlMgr
    {
        public string[] model_array = {
            ...
            "1Rail_Den_100",
            "1Rail_Den_100W",
            "1Rail_Den_100_Konkuri",
            "1Rail_Den_100_Under",
            "1Rail_Den_25",
            "1Rail_Den_25W",
            "1Rail_Den_25_Konkuri",
            "1Rail_Den_25_Under",
            "1Rail_Den_50",
            "1Rail_Den_50W",
            "1Rail_Den_50_Konkuri",
            "1Rail_Den_50_Under",
            "1Rail_HQ_50Only",
            "1Rail_HQ_Konkuri100",
            ...
            "2Rail100Only",
            "2Rail25Only",
            "2Rail_Bridge50_Miman",
            "2Rail_DenBridge138",
            "2Rail_Den_100",
            "2Rail_Den_100_AMB",
            "2Rail_Den_100_Konkuri",
            "2Rail_Den_100_Under",
            "2Rail_Den_100_Under2",
            "2Rail_Den_100_Under3",
            "2Rail_Den_100_Under4",
            "2Rail_Den_100_Under5",
            "2Rail_Den_100_Under6",
            "2Rail_Den_100_Under7",
            "2Rail_Den_100_Wall",
            "2Rail_Den_25",
            "2Rail_Den_25_AMB",
            "2Rail_Den_25_H",
            "2Rail_Den_25_H2",
            "2Rail_Den_25_Konkuri",
            "2Rail_Den_50",
            "2Rail_Den_50_AMB",
            "2Rail_Den_50_Only",
            "2Rail_Den_50_Wall",
            ...
            "2Rail_Kin_50_AMB",
            "2Rail_Kin_50_Wall",
            "2Rail_Mina_100_Under",
            "2Rail_Mina_100_UnderJari",
            "2Rail_Mina_Under",
            "2Rail_Takara100Only",
            "2Rail_Takara25Only",
            "2Rail_Takara50Only",
        ...
        public GameObject MdlCreate(string mdl_name, string type, Main mMain)
        {
            ...
            for (int i = 0; i < amb_model_array.Length; i++)
            {
                amb_model_array[i] = amb_model_array[i].ToUpper();
            }
            ...
            {
                if (System.Array.IndexOf(amb_model_array, search_mdl) == -1)
                {
                    mMain.DebugError("AMBとして置けないモデル：" + mdl_name);
                    return null;
                }
            }
            else if (type == "kasenchu")
            {
                if (search_mdl.ToLower().IndexOf("kasenchu") < 0)
                {
                    mMain.DebugError("架線柱として置けないモデル：" + mdl_name);
                    return null;
                }
            }
            else
            ...
            string path = string.Format("prefab/{0}", mdl_name);
